	...
	<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
		<header class="entry-header">
			...
			<div class="entry-meta">
                <span class="entry-author"><?php vutton_posted_by(); ?></span>
			    <?php if ( 'post' == get_post_type() ) : ?>
				    <span class="entry-date"><?php vutton_posted_on(); ?></span>
			    <?php endif; ?>
			    <?php if(comments_open() && !post_password_required()): ?>
			    <span class="comments-link">
				    <?php comments_popup_link('<span class="leave-reply">'
                        . __( 'Reply', 'twentyeleven' ) . '</span>', '1 commentaire', '% commentaires'); ?>
			    </span>
			<?php endif; ?>
			</div><!-- .entry-meta -->
		</header><!-- .entry-header -->
		...
		<footer class="entry-meta row-fluid">
            ...
            <div class="span6">
			    ...
			    <?php if ( $show_sep ) : ?> - <?php endif; // End if $show_sep ?>
